...
<div class="mb-4">
    ...
    <p class="text-muted">Masukkan data mahasiswa sesuai dengan 15 kolom pada Tugas 1.</p>
</div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="status_mahasiswa" class="form-select" required>
                        ...
                        <option value="Nonaktif" {{ old('status_mahasiswa') == 'Nonaktif' ? 'selected' : '' }}>Nonaktif</option>
                    </select>
                </div>
